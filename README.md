...
# GraphMAE Self-Supervised Graph Lab

![Demo Screenshot](demo/screenshot.png)

## Overview
Create a self-supervised graph lab for pretraining, downstream transfer, and graph representation analysis with polished demos.
...
## Project Profile
- Domain: Self-Supervised Graph Learning
- Project type: `ml`
- Tags: graphmae, graph, self-supervised, gnn
